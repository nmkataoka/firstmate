...
Shared tracked material is `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, `.tasks.toml`, `.github/workflows/`, `bin/`, `.agents/skills/`, `crew/`, and public `skills/`.
...
crew/review/         fork-specific post-implementation review procedure, prompts, and PR evidence guidance, committed
...
config/review.env    optional fork-specific reviewer launch overrides; LOCAL, gitignored; read by bin/fm-review-launch.sh
...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  <id>/screenshots/  visual-PR evidence saved under the generated ship-brief carve-out; survives teardown
...
state/               volatile runtime signals; gitignored
  ...
  .last-watcher-beat watcher liveness beacon, touched every poll and re-stamped when a wake fires; guard scripts read it
...
This fork's `pr-review-dispatch` workflow is the deliberate narrow exception: when intake selects a review tier for a direct-PR ship, the generated brief runs its tracked dual-review procedure without authorizing stacked review elsewhere.
...
- `pr-review-dispatch` - load at intake before dispatching a ship task that should use this fork's dual-review exception and before choosing its review tier.
