...
#
# Requires: herdr (CLI + socket), jq (JSON parsing). herdr is gated behind
# selecting this backend; jq is part of bin/fm-bootstrap.sh's universal tool
# list and is rechecked here.
