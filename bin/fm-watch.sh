...
#                          resume. An acked terminal park (bin/fm-stale-ack.sh;
#                          policy stale_is_acked in fm-classify-lib.sh) is
#                          absorbed with no wedge timer while the status log's
#                          last line matches the ack. Unless afk is active.
