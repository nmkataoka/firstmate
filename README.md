...
- [docs/arm-pretool-check.md](docs/arm-pretool-check.md) - the pre-arm PreToolUse seatbelt that denies known-bad watcher-arm command shapes: shared predicate, per-harness wiring, and validation evidence.
