...
- Are the tests testing mocks or intermediate artifacts instead of real functionality that is easily testable?
  ...
  - Are phrase assertions used only as generated-output contract tests where a generator must include required sections, never for hand-authored prompt or instruction text?
